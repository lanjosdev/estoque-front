...
export function CreateInput({ close, setReflashState }) {
    ...
    useEffect(()=> {
        async function checkChangeProductSelect() {
            ...
            setStorageSelect(productSelect?.fk_storage_location_id ? {
                id: productSelect.fk_storage_location_id
            } : null);
    ...
    async function handleSubmitCreateInput(e) 
    {
        ...
        const alertDays = alertDaysRef.current?.value || null;
    ...
    return (
        <div className='Window CreateInput grid'>
            ...
            disabledComponent={productSelect?.name_storage_location ? true : false}
            defaultSearch={productSelect?.name_storage_location}
            />
